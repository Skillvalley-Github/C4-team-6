...
function Createevnet() {
  return (
    ...
    <form>
        <div className='grid justify-center bg-color-2 space-y-6 mt-10 w-[300px] md:w-[500px] py-10 font-6'>
            <div>
            ...
            <div className='grid md:flex md:space-x-4 items-center '>
                ...
                <input 
                type="text" 
                placeholder="Enter Event Banner"
                />
            </div>
            <div className='grid md:flex md:space-x-4 items-center '>
            ...
            <div className='grid md:flex md:space-x-4 items-center '>
                <label className='w-[150px]'>Speaker Image</label>
                <input 
                type='url'
                placeholder="Enter Speaker Image"
                s/>
            </div>
            <div className='flex justify-center'>
